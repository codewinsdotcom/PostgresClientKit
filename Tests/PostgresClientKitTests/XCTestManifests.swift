...
extension Analysis {
    ...
    static let __allTests__Analysis = [
        ...
        ("testThreadDictionary", testThreadDictionary),
    ]
}
...
extension ExistingPerformance {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__ExistingPerformance = [
        ("test", test),
    ]
}

extension FoundationBugs {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__FoundationBugs = [
        ("testSR10515", testSR10515),
        ("testSR10516", testSR10516),
        ("testSR11569", testSR11569),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        testCase(Analysis.__allTests__Analysis),
        ...
        testCase(ExistingPerformance.__allTests__ExistingPerformance),
        testCase(FoundationBugs.__allTests__FoundationBugs),
